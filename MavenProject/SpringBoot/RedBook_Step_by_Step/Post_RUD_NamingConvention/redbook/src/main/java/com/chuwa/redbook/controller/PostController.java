...
public class PostController {
    ...
    // use request request parameter
    @GetMapping("/search")
    public ResponseEntity<List<PostDto>> searchByKeyword(@RequestParam(value = "keyword") String keyword) {
        try {
            List<PostDto> postDtos = postService.searchByKeyword(keyword);
