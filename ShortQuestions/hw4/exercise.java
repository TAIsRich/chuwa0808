...
public class exercise {
    ...
    public void exercise4() {
        ...
        List<Product> result = orderRepo.findAll()
                ...
                .filter(order -> order.getOrderDate().isBefore(LocalDate.of(2021, 4, 2)))
    ...
    public void exercise8() {
        ...
        Double result = orderRepo.findAll()
                .stream().filter(order -> order.getOrderDate().isAfter(LocalDate.of(2021, 1, 31)))
    ...
    public void exercise11() {
        ...
        long endTime = System.currentTimeMillis();
        log.info(String.format("exerci se 11 - execution time: %1$d ms", (endTime - startTime)));
