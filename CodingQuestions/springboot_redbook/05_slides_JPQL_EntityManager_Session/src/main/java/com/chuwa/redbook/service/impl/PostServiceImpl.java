...
//        return postResponse;
        ...
        Post savedPost = postJPQLRepository.save(post);
    ...
    public List<PostDto> getAllPost() {
        List<Post> posts = postJPQLRepository.findAll();
...
//        post.orElseThrow(() -> new ResourceNotFoundException("Post"),"id", id);
        ...
        Post post = postJPQLRepository.findById(id).orElseThrow(() -> new ResourceNotFoundException("Post", "id", id));
    ...
    public PostDto updatePost(PostDto postDto, long id) {
        ...
        post.setDescription(postDto.getDescription());
        post.setContent(postDto.getContent());
        Post updatePost = postJPQLRepository.save(post);
    ...
    public void deletePostById(long id) {
        Post post = postJPQLRepository.findById(id).orElseThrow(() -> new ResourceNotFoundException("Post", "id", id));
        postJPQLRepository.delete(post);
    }

    @Override
    public PostDto findPostByTitle(String title) {
        Post post = postJPQLRepository.findPostByTitle(title);
        return mapToDTO(post);
    }

    @Override
    public List<PostDto> findPostByIdGreaterThan(long id) {
        List<Post> posts = postJPQLRepository.findPostByIdGreaterThan(id);
