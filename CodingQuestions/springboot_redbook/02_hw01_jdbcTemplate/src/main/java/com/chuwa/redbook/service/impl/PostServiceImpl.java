...
import com.chuwa.redbook.dao.PostJDBC;
...
//        post.setContent(postDto.getContent());
        ...
        // save()会返回存储在数据库中的数据
        Post savedPost = postJDBC.save(post);
...
//        postResponse.setContent(savedPost.getContent());
    ...
    public List<PostDto> getAllPost() throws Exception {
        List<Post> posts = (List<Post>) postJDBC.findAll();
...
//        Post post = postRepository.findById(id).get();
    ...
    public PostDto updatePost(PostDto postDto, long id) throws Exception {
        ...
        Post updatePost = postJDBC.save(post);
